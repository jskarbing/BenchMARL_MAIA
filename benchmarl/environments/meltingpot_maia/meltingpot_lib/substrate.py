...
# import meltingpot.substrate

# Slightly modified version of meltingpot/substrate.py with:
...
from benchmarl.environments.meltingpot_maia.meltingpot_lib.configs import substrates as substrate_configs
